...
curl -o- https://raw.githubusercontent.com/obe711/linux-install-scripts/main/install_misc.sh | bash
...
curl -o- https://raw.githubusercontent.com/obe711/linux-install-scripts/main/install_mosquitto.sh | bash
